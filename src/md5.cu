...
// local functions
// clang-format off
__device__ static void md5_update (struct md5_ctx *);
__device__ static void md5_final  (uint8_t *, struct md5_ctx *);
__device__ static void md5_encode (uint8_t *, struct md5_ctx *);
__device__ static void md5_addsize(uint8_t *, uint32_t, uint32_t);
// clang-format on

__device__ void
md5(uint8_t *const M, uint32_t len, uint8_t *digest)
{
...
md5_addsize(uint8_t *M, uint32_t index, uint32_t oldlen)
{
...
__device__ static void
md5_final(uint8_t *digest, struct md5_ctx *context)
{
    uint8_t buffer[64] = { 0 }; /* 512 bits */
    uint32_t i         = 0;
    ...
    // clang-format off
    const unsigned char MD5_PADDING[64] = { /* 512 Bits */
...
__device__ static void
md5_encode(uint8_t *buffer, struct md5_ctx *context)
{
